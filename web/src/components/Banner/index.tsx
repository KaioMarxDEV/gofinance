  ...
  return (
    <div className="w-full">
      <div className="relative -top-20 max-w-6xl px-6 mx-auto flex flex-row items-center justify-between">
        ...
        <div className="bg-gray-800 flex flex-col justify-between transition-all ease-in delay-75 duration-200 hover:-translate-y-1  border-2 h-36 p-6 rounded-lg w-full">
