      ...
      <div className="w-full max-w-6xl px-6 mx-auto flex flex-row justify-between items-center">
        ...
        <div>
          <button
            type="button"
            onClick={() => handleModal()}
            className="rounded-md border border-green-500 hover:bg-green-700 hover:shadow-lg
            focus:bg-green-500 focus:shadow-lg focus:outline-none focus:ring-0
            active:bg-green-500 active:shadow-lg transition-all ease-in-out
              duration-150 h-full w-full px-5 py-2"
            >
